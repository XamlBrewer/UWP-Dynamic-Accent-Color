...
namespace XamlBrewer.Uwp.DynamicAccentColor
{
    public sealed partial class Shell
    {
        public Shell()
        {
            ...
            // Register page specific accent colors.
            Theme.RegisterAccentColor(typeof(BirdPage), (Color)Application.Current.Resources["BirdAccentColor"]);
            Theme.RegisterAccentColor(typeof(DonkeyPage), (Color)Application.Current.Resources["DonkeyAccentColor"]);
            Theme.RegisterAccentColor(typeof(HorsePage), (Color)Application.Current.Resources["HorseAccentColor"]);
            Theme.RegisterAccentColor(typeof(RabbitPage), (Color)Application.Current.Resources["RabbitAccentColor"]);
        ...
        private async void Menu_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            if (e.AddedItems.Count > 0)
            {
                ...
                {
                    await Navigation.Navigate(menuItem.NavigationDestination);
                }
            }
        }
